...
class ReglementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reglements = $em->getRepository('BackBundle:Reglement')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BackBundle\Form\ReglementType', $reglement);
    ...
    {
        $deleteForm = $this->createDeleteForm($reglement);
        $editForm = $this->createForm('BackBundle\Form\ReglementType', $reglement);
