...
use BackBundle\Entity\Presentation;
...
class PresentationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $presentations = $em->getRepository('BackBundle:Presentation')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BackBundle\Form\PresentationType', $presentation);
    ...
    {
        $deleteForm = $this->createDeleteForm($presentation);
        $editForm = $this->createForm('BackBundle\Form\PresentationType', $presentation);
